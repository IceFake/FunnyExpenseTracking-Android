...
android {
    ...
    defaultConfig {
        ...
        // 默认线上环境地址；本地测试地址由 ApiEnvironmentConfig.IS_TEST_ENV 控制切换到 10.0.2.2
        buildConfigField("String", "API_BASE_URL", "\"https://api.your-domain.com/v1/\"")
        buildConfigField("String", "LOCAL_API_BASE_URL", "\"http://10.0.2.2:8081/v1/\"")
