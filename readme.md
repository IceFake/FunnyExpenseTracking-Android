...
| **构建工具** | Gradle Kotlin DSL | 8.13.2 | Version Catalog 统一依赖管理 |
...
2. 在应用内「AI 分析」页面 → 点击「API Key 设置」→ 输入 Key
3. Key 通过 `EncryptedSharedPreferences`（AES256-GCM）加密存储
...
- [🏗️ 项目架构详解](PROJECT_ARCHITECTURE.md)
- [👨‍💻 开发者指南](AGENTS.md)
